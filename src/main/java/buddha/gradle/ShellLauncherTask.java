...
public class ShellLauncherTask extends ConventionTask implements Constants {
    @Setter
    ...
    private void generateWinShellLauncher() {
        ...
        // 设置脚本必要的全局变量
        batContent.append("@rem This script is generated by the 'shell-launcher' plugin\n");
        batContent.append("@echo off").append("\n");
        batContent.append("@rem Initialize the basic global variables\n");
        ...
        batContent.append("@rem Config the application runtime classpath\n");
        // 设置classpath
        ...
        batContent.append("@rem Start the application\n");
        // 这里用来切换jvm的工作目录
    ...
    public void actionPerformed() {
        ...
        if (currentPlatformOnly) {
            // 仅生成当前操作系统的启动脚本
            if (Objects.equals(os, OS_WIN)) {
                generateWinShellLauncher();
            } else if (Objects.equals(os, OS_UNIX_LIK)) {
